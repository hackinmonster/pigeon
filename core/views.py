...
def homepage(request):
    ...
    return render(request, 'core/homepage.html', {'user_profile': user_profile})
...
def edit_student_profile(request):
    return render(request, 'core/edit_student_profile.html')

def employer_profile(request):
    return render(request, 'core/employer_profile.html')

def edit_employer_profile(request):
    return render(request, 'core/edit_employer_profile.html')